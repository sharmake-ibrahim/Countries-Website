...
const EuropeViewPage = ()=> {

    const  {europeData} = useContext(GlobalContext);
  
    
        const {europe_Id} = useParams();
        ...
        const countryDetail =  europeData.find( (detial)=>  detial.area === parseInt(europe_Id));
    ...
    return(
       ...
       <main>
            ...
            <button type="button" class="btn btn-success content-btn"> <Link to= "/europe">Back</Link></button>
